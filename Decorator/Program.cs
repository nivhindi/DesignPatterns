...
namespace Decorator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IPizza myfavoritePizza = new HalfPriceDiscount(new OnionTopping(new TomatoTopping(new CheeseTopping(new BasePizza()))));
            Console.WriteLine(myfavoritePizza.GetDetails() + myfavoritePizza.GetPrice());
